...
//  //pr($arrArticles);
//  
//  foreach ($arrArticles as $key => $arrValues) {
//  
//
//      pr($arrValues['Article']['id']);
//       pr($arrValues['Article']['article_title']);
//      
//  }
    echo $this->Html->script('jquery');
    $this->Paginator->options(
                            array('update'=>'#content1',
...
<div >
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('article_title'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($article['Article']['article_content']); ?>&nbsp;</td>
